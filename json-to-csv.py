...
with open('./snapshots/h2-as-server/snapshot-h4-client-h2-server--fallback-formatted.txt', 'r') as jsonfile:
...
filename = './snapshots/h2-as-server/snapshot-h4-client-h2-server.csv'
