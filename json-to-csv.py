...
with open('./snapshots/h4-as-server/snapshot-h3-client-h4-server--fallback-formatted.txt', 'r') as jsonfile:
...
filename = './snapshots/h4-as-server/snapshot-h3-client-h4-server.csv'
