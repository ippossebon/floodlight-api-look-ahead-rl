...
def trainAgent(env):
    ...
    model.save('./A2C_100_lr_005_gamma_097-disc-env')
    print('Modelo treinado e salvo.')


def testAgent(env):
    print('Testando o agente...')
    model = A2C.load(load_path='./A2C_100_lr_005_gamma_097-disc-env', env=env)
...
def plotGraphs(p0, p1, p2, p3, p4, p5, p6, p7, p8,p9, p10, p11, p12, p13, p14, p15):
    ...
    plt.savefig('A2C_100-100_steps-005-097-23_set.pdf')
