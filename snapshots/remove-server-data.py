...
filename = './h1-as-server/snapshot-h4-client-h1-server.csv'
output_filename = './h1-as-server/snapshot-h4-client-h1-server--serverless-data.csv'

instances = []

SOURCE_ETH = '00:00:00:00:00:01'
TARGET_ETH = '00:00:00:00:00:04'
