def linksToPaths(links):
    ...
    action_0 = path_c_g_i + path_b_f_i
    action_1 = path_b_d_h_i + path_b_e_g_i
    action_2 = path_b_f_i
    action_3 = path_c_g_i + path_c_e_f_i
    action_4 = path_c_g_i
    action_5 = path_b_d_h_i
    action_6 = path_b_e_g_i
    action_7 = path_c_e_d_h_i
    action_8 = path_c_e_f_i
    action_9 = path_b_d_h_i + path_b_e_g_i + path_b_f_i
